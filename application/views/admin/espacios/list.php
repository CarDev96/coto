                                          ...
                                          <a href="<?=base_url()?>assets/images/espacios/<?php echo $info_espacios->foto_es;?>" class="example-image-link" data-lightbox="example-1"><img src="<?=base_url()?>assets/images/espacios/thumbs/<?php echo $info_espacios->foto_es;?>" class="img-responsive" style=" width: auto; height: auto;" >
											...
											<?php if($permisos->insercion==1):?>
                                                        <td align="center">
															...
															<a href="<?php echo base_url(); ?>Administrador/Espacios/reservas/<?php echo $info_espacios->id_es; ?>" class="btn btn-primary btn-circle btn-small"><i class="fa fa-calendar"></i></a>
                                                        ...
                                                        <td align="center">
															...
															<a href="<?php echo base_url(); ?>Administrador/Espacios/edit/<?php echo $info_espacios->id_es; ?>" class="btn btn-warning btn-circle btn-small"><i class="fa fa-edit"></i></a>
															<a href="<?php echo base_url(); ?>Administrador/Espacios/delete/<?php echo $info_espacios->id_es; ?>" class="btn btn-danger btn-circle btn-small"><i class="fa fa-remove"></i></a>
