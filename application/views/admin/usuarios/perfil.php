                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    ...
                                    <?php if($info_usuario->pass == "1841363b0b95a95f04d73c722d7003df048049bf"): ?>                                        
                                        <form class="form-horizontal form-material" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>Principal/Perfil/actualizar_p" autocomplete="off">
                                        <?php else:?>
                                        <form class="form-horizontal form-material" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>Principal/Perfil/actualizar_p2" autocomplete="off">
                                        <?php endif; ?>                                        
