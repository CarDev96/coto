        		...
        		<div class="row">
        			<div class="col-lg-12">
        				<div class="card card-outline-info">
        					...
        					<div class="card-body">
        						<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>Principal/Visitas/nuevo_g" enctype="multipart/form-data">
        							...
        							<div class="form-body">
        								...
        								<div class="row">
        									<div class="col-md-6">
        										<div class="form-group row">
        											<label class="control-label text-right col-md-4">Selecciona la casa:</label>
        											<div class="col-md-6">

        												<select class="select2 form-control custom-select" name="id_casa" id="id_tipo_vi" style="width: 100%; height:36px;">
        								...
        								<div class="row">
        									<div class="col-md-6">
        										<div class="form-group row">
        											<label class="control-label text-right col-md-3">INE:</label>
        											<div class="col-md-9">


        												<input type="file" id="input-file-max-fs" class="dropify4" name="foto_ine" data-max-file-size="2M" />
        									...
        									<div class="col-md-6">
        										<div class="form-group row">
        											<label class="control-label text-right col-md-3">Automóvil:</label>
        											<div class="col-md-9">


        												<input type="file" id="input-file-max-fs" class="dropify3" name="foto_auto" data-max-file-size="2M" />
