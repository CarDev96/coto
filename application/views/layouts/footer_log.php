...
<script src="<?php echo base_url();?>js/tether/tether.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>js/match-height/jquery.matchHeight.min.js"></script>
